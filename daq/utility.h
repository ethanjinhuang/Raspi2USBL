 ...
 ****************************************************************************/
inline void ConvertInputModeToString(AiInputMode inputMode, char *modeStr) {
    switch (inputMode) {
...
inline void ConvertRangeToString(Range range, char *rangeStr) {
    switch (range) {
        case (BIP60VOLTS):
...
inline void ConvertRangeToMinMax(Range range, double *min, double *max) {
    switch (range) {
        case (BIP60VOLTS):
            *min = -60.0;
            *max = 60.0;
...
inline void ConvertTriggerTypeToString(TriggerType triggerType, char *triggerTypeStr) {
    switch (triggerType) {
        case (TRIG_NONE):
...
inline void ConvertPortTypeToString(DigitalPortType portType, char *portTypeStr) {
    switch (portType) {
        case (AUXPORT0):
...
inline void ConvertPortIoTypeToString(DigitalPortIoType portIoType, char *portIoTypeStr) {
    switch (portIoType) {
        case (DPIOT_IN):
...
inline void ConvertEventTypesToString(DaqEventType eventType, char *eventTypeStr) {
    switch (eventType) {
        case (DE_NONE):
...
inline void ConvertScanOptionsToString(ScanOption scanOptions, char *scanOptionsStr) {
...
inline void ConvertDaqIChanTypeToString(DaqInChanType daqiChanType, char *daqiChanTypeStr) {
    switch (daqiChanType) {
...
inline void ConvertDaqOChanTypeToString(DaqOutChanType daqoChanType, char *daqoChanTypeStr) {
    switch (daqoChanType) {
        case (DAQI_ANALOG_DIFF):
...
inline void ConvertTCTypeToString(TcType type, char *typeStr) {
    switch (type) {
        case (TC_J):
            strcpy(typeStr, "J");
            break;
...
inline void ConvertSensorConnectionTypeToString(SensorConnectionType type, char *typeStr) {
    switch (type) {
        case (SCT_2_WIRE_1):
 ...
 ****************************************************************************/
inline UlError getDevInfoHasAi(DaqDeviceHandle daqDeviceHandle, int *hasAi) {
...
inline UlError getDevInfoHasAo(DaqDeviceHandle daqDeviceHandle, int *hasAo) {
...
inline UlError getDevInfoHasDio(DaqDeviceHandle daqDeviceHandle, int *hasDio) {
...
inline UlError getDevInfoHasCtr(DaqDeviceHandle daqDeviceHandle, int *hasCtr) {
...
inline UlError getDevInfoHasTmr(DaqDeviceHandle daqDeviceHandle, int *hasTmr) {
...
inline UlError getDevInfoHasDaqi(DaqDeviceHandle daqDeviceHandle, int *hasDaqi) {
...
inline UlError getDevInfoHasDaqo(DaqDeviceHandle daqDeviceHandle, int *hasDaqo) {
 ...
 ****************************************************************************/
inline UlError getAiInfoHasPacer(DaqDeviceHandle daqDeviceHandle, int *hasPacer) {
...
inline UlError getAiInfoFirstTriggerType(DaqDeviceHandle daqDeviceHandle, TriggerType *triggerType,
                                         char *triggerTypeStr) {
    UlError err            = ERR_NO_ERROR;
...
inline UlError getAiInfoRanges(DaqDeviceHandle daqDeviceHandle, AiInputMode inputMode, int *numberOfRanges,
                               Range *ranges) {
    UlError   err       = ERR_NO_ERROR;
    int       i         = 0;
...
inline UlError getAiInfoFirstSupportedInputMode(DaqDeviceHandle daqDeviceHandle, int *numberOfChannels,
                                                AiInputMode *inputMode, char *inputModeStr) {
    UlError err = ERR_NO_ERROR;
...
inline UlError getAiInfoFirstSupportedRange(DaqDeviceHandle daqDeviceHandle, AiInputMode inputMode, Range *range,
                                            char *rangeStr) {
    UlError   err = ERR_NO_ERROR;
    long long rng;
...
inline UlError getAiInfoQueueTypes(DaqDeviceHandle daqDeviceHandle, int *queueTypes) {
    UlError   err = ERR_NO_ERROR;
    long long qTypes;
...
inline UlError getAiInfoHasTempChan(DaqDeviceHandle daqDeviceHandle, int *hasTempChan, int *numberOfChannels) {
...
inline UlError getAiInfoIepeSupported(DaqDeviceHandle daqDeviceHandle, int *iepeSupported) {
...
inline UlError getAiConfigTempChanConfig(DaqDeviceHandle daqDeviceHandle, int chan, char *chanTypeStr,
                                         char *sensorStr) {
    UlError   err          = ERR_NO_ERROR;
    long long chanTypeMask = 0;
 ...
 ****************************************************************************/
inline UlError getAoInfoHasPacer(DaqDeviceHandle daqDeviceHandle, int *hasPacer) {
    UlError   err = ERR_NO_ERROR;
...
inline UlError getAoInfoFirstTriggerType(DaqDeviceHandle daqDeviceHandle, TriggerType *triggerType,
                                         char *triggerTypeStr) {
    UlError   err          = ERR_NO_ERROR;
    long long triggerTypes = 0;
...
inline UlError getAoInfoFirstSupportedRange(DaqDeviceHandle daqDeviceHandle, Range *range, char *rangeStr) {
    UlError   err = ERR_NO_ERROR;
    long long rng;
 ...
 ****************************************************************************/
inline UlError getDioInfoHasPacer(DaqDeviceHandle daqDeviceHandle, DigitalDirection direction, int *hasPacer) {
    UlError   err = ERR_NO_ERROR;
    long long pacerSupport;
...
inline UlError getDioInfoFirstSupportedPortType(DaqDeviceHandle daqDeviceHandle, DigitalPortType *portType,
                                                char *portTypeStr) {
    UlError   err   = ERR_NO_ERROR;
    long long pType = 0;
...
inline UlError getDioInfoNumberOfBitsForFirstPort(DaqDeviceHandle daqDeviceHandle, int *bitsPerPort) {
    UlError   err = ERR_NO_ERROR;
    long long numBits;
...
inline UlError getDioInfoFirstSupportedPortIoType(DaqDeviceHandle daqDeviceHandle, DigitalPortIoType *portIoType,
                                                  char *portIoTypeStr) {
    UlError   err = ERR_NO_ERROR;
    long long ioType;
 ...
 ****************************************************************************/
inline UlError getCtrInfoNumberOfChannels(DaqDeviceHandle daqDeviceHandle, int *numberOfCtrChannels) {
    UlError   err = ERR_NO_ERROR;
    long long numChans;
...
inline UlError getCtrInfoHasPacer(DaqDeviceHandle daqDeviceHandle, int *hasPacer) {
    UlError   err = ERR_NO_ERROR;
    long long pacerSupport;
...
inline UlError getCtrInfoSupportedEventCounters(DaqDeviceHandle daqDeviceHandle, int *eventCounters,
                                                int *numberOfEventCounters) {
    UlError   err              = ERR_NO_ERROR;
    int       i                = 0;
...
inline UlError getCtrInfoSupportedEncoderCounters(DaqDeviceHandle daqDeviceHandle, int *encoders,
...
inline UlError getCtrInfoMeasurementTypes(DaqDeviceHandle daqDeviceHandle, long long counterNumber,
 ...
 * DAQI Info Functions
 ****************************************************************************/
inline UlError getDaqiChannelTypes(DaqDeviceHandle daqDeviceHandle, int *chanTypesMask) {
    UlError   err = ERR_NO_ERROR;
    long long ctMask;
...
inline UlError getDaqiInfoFirstTriggerType(DaqDeviceHandle daqDeviceHandle, TriggerType *triggerType,
                                           char *triggerTypeStr) {
    UlError err            = ERR_NO_ERROR;
 ...
 * DAQO Info Functions
 ****************************************************************************/
inline UlError getDaqoChannelTypes(DaqDeviceHandle daqDeviceHandle, int *chanTypesMask) {
    UlError   err = ERR_NO_ERROR;
    long long ctMask;
...
inline int selectDAQDevice(int numberOfDAQDevices) {
